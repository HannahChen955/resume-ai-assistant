...
OUTPUT_DIR = "../data/resumes_extract_qianwen"
...
def qianwen_extract_fields(text):
    snippet = text[:600]
    prompt = f"""
...
def main():
    ...
    for filename in tqdm(files, desc="Extracting with Qianwen"):
        try:
            ...
            fields = qianwen_extract_fields(text) or {}
